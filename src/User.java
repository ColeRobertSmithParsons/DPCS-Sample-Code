...
public class User extends Object{
	...
	private String city;
	//private int bronzeplan;
	//private int silverplan;
	//private int goldplan;
	...
	/* public void discount() {
		...
		if (age <= 18) {
			...
			System.out.println("Qualifies for a Student Discount (-15%)");
		}else if(age >=65) {
			seniorDiscount = true;
			System.out.println("Qualifies for a Senior Discount (-15%)");
		}
	}
	//*/
	...
	public static ArrayList goldmails() {
		return null;
